...
namespace _Fly_Connect.Scripts.Sound.Music_Manager
{
    public class MusicManager : MonoBehaviour
    {
        public static event Action<bool> OnMuted
        {
            add
            {
                if (instance != null) instance.player.OnMuted += value;
            }
            remove
            {
                if (instance != null) instance.player.OnMuted -= value;
        ...
        public static event Action<float> OnVolumeChanged
        {
            add
            {
                if (instance != null) instance.player.OnVolumeChanged += value;
            }
            remove
            {
                if (instance != null) instance.player.OnVolumeChanged -= value;
        ...
        public static event Action OnStarted
        {
            add
            {
                if (instance != null) instance.player.OnStarted += value;
            }
            remove
            {
                if (instance != null) instance.player.OnStarted -= value;
        ...
        public static event Action OnPaused
        {
            add
            {
                if (instance != null) instance.player.OnPaused += value;
            }
            remove
            {
                if (instance != null) instance.player.OnPaused -= value;
        ...
        public static event Action OnResumed
        {
            add
            {
                if (instance != null) instance.player.OnResumed += value;
            }
            remove
            {
                if (instance != null) instance.player.OnResumed -= value;
        ...
        public static event Action OnStopped
        {
            add
            {
                if (instance != null) instance.player.OnStopped += value;
            }
            remove
            {
                if (instance != null) instance.player.OnStopped -= value;
        ...
        public static event Action OnFinsihed
        {
            add
            {
                if (instance != null) instance.player.OnFinsihed += value;
            }
            remove
            {
                if (instance != null) instance.player.OnFinsihed -= value;
        ...
        public static bool IsMute
        {
            ...
            set
            {
                if (instance != null) instance.player.IsMute = value;
            }
        }
        ...
        public static float Volume
        {
            ...
            set
            {
                if (instance != null) instance.player.Volume = value;
            }
        }
        ...
        [SerializeField] private MusicPlayer.MusicPlayer player;
